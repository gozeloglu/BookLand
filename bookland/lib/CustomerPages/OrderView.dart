...
class OrderView extends StatelessWidget {
  ...
  OrderView({Key key, @required this.orderid}) : super(key: key);
  final  HTTPAll httporder = HTTPAll();



  static const String _title = 'OrderView';
  @override
    ...
    return  Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text("\t\t\$" + ( (double.parse(totalCost) - double.parse(shippingCost)).toStringAsFixed(2) ) ,style: TextStyle(fontWeight: FontWeight.normal,fontSize: 15), ),
